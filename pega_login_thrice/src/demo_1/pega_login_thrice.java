...
public class pega_login_thrice {

	String projectPath = System.getProperty("user.dir");
	WebDriver driver; 
	@Parameters("Logintype")
	@BeforeTest
	public void setup(String Logintype) {
		if (Logintype.equalsIgnoreCase("first")) {
			System.setProperty("webdriver.chrome.driver", projectPath+"/Drivers/chromedriver.exe");
			driver = new ChromeDriver();
			} else if (Logintype.equalsIgnoreCase("second")) {
			System.setProperty("webdriver.chrome.driver", projectPath+"/Drivers/chromedriver.exe");
			driver = new ChromeDriver();
			}
			else if (Logintype.equalsIgnoreCase("Third")) {
				System.setProperty("webdriver.chrome.driver", projectPath+"/Drivers/chromedriver.exe");
				driver = new ChromeDriver();
				}
		}
